...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0ef6ebbb-1084-4159-bd64-aaa98c292da1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('272c8c66-56dd-4d9d-9de5-7ee8e08f8bb2');
      cy.get(`[data-cy="name"]`).should('have.value', '272c8c66-56dd-4d9d-9de5-7ee8e08f8bb2');
